 ...
 *   you should first look at how aether core implements those functions:
 *     theme_breadcrumbs()      in aether/template.php
 *     theme_menu_item_link()   in aether/template.php
 *     theme_menu_local_tasks() in aether/template.php
 *
